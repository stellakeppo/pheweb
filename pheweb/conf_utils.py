...
def _ensure_conf():
    ...
    default_per_assoc_fields = OrderedDict([
        ...
        ('maf', {
            ...
            'range': [0, 1],
            'sigfigs': 2,
            'tooltip_underscoretemplate': 'MAF UKBB: <%= d.maf.toFixed(4) %><br>',
        ...
        ('maf_case', {
            ...
            'range': [0, 1],
            'sigfigs': 2,
            'tooltip_underscoretemplate': 'MAF cases FinnGen: <%= d.maf_case.toFixed(4) %><br>',
            'tooltip_lztemplate': {'transform': '|percent'},
            'display': 'MAF cases',
        }),
        ('maf_control', {
            ...
            'range': [0, 1],
            'sigfigs': 2,
            'tooltip_underscoretemplate': 'MAF controls FinnGen: <%= d.maf_control.toFixed(4) %><br>',
            'tooltip_lztemplate': {'transform': '|percent'},
        ...
        ('maf_cases', {
            ...
            'range': [0, 1],
            'sigfigs': 2,
            'tooltip_underscoretemplate': 'MAF cases FinnGen: <%= d.maf_cases.toFixed(4) %><br>',
            'tooltip_lztemplate': {'transform': '|percent'},
            'display': 'MAF cases',
        }),
        ('maf_controls', {
            ...
            'range': [0, 1],
            'sigfigs': 2,
            'tooltip_underscoretemplate': 'MAF controls FinnGen: <%= d.maf_controls.toFixed(4) %><br>',
            'tooltip_lztemplate': {'transform': '|percent'},
            'display': 'MAF controls',
        }),
        ('af', {
