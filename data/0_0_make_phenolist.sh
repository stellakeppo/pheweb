...
./phenolist.py glob-files "/net/fantasia/home/schellen/PheWAS/epacts/14NOV_SNA2_RESULTS/pheno.*/pheno.*.epacts.gz"
...
./phenolist.py rename-columns -f "$data_dir/pheno-list-phewascodes.json"   icd9 icd9_code   category_string category
